...
title: "Exterior Algebra II"
subtitle: "Star Indices"
date: "2025-01-17"
math: true
toc: true
...
This differs from the $$\star$$-index in that the vector $$\mathbf{e}_i$$ has been removed "in place" rather than first being transposed to the front of ths list. We can represent this with another special multi-index $$\enclose{horizontalstrike}{i}$$, which I'll call "strike-$$i$$". The two differ by a sign, since it takes $$i-1$$ transposition to move $$i$$ from the front of the list to its normal position:
