...
$$(\perp B)$$ would be a 90-degree rotation of vector $$(a, -b)$$, i.e. $$y \propto (b, a)$$ and fixing one component to 1 would give our solution: $$y = (b/a, 1)$$ and $$x = b/a$$. It's remarkable that the N-dimensional case ends up look similar.
