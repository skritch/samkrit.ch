...
import { } from '@atcute/client';
import {LuX} from "react-icons/lu";

// Can't figure out how to get this to work like the original code
// import type { AppBskyFeedPost } from '@atcute/client/lexicons';

// TODO: update CSS in this class.
// Test
// log embeds we can't handle
...
const MultiImageLayout = ({
  ...
  did: string;
  images: bluesky.AppBskyEmbedImages.Image[];
}) => {
